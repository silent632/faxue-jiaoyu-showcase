...
const COURSE_MATERIALS_BY_PERIOD = {
  第一期: [
    "课件：类案检索与法律适用（0905）.pptx",
    "课件：类案检索与法律适用（0905）(1).pdf",
    "司法裁判的“同”与“不同”：当法官自由裁量遇上科技赋能(1).pdf",
  ],
  第二期: [
    "课件：权利义务相一致原则的理论与实践.pptx",
    "课件：权利义务相一致原则的理论与实践(1).pdf",
    "权利义务相一致原则的规范分析与实践应照（8月8号晚修订版）.docx",
  ],
  第三期: [
    "多元纠纷解决机制与商事仲裁实务(12.16修改版)(4).pptx",
    "多元纠纷解决机制与商事仲裁实务pdf.pdf",
    "课堂导读与程序讨论记录",
  ],
  第四期: [
    "1223“法律不保护躺在权利上睡觉的人“——从“沉睡的权利”到正当救济的司法考量.pptx",
    "1223“法律不保护躺在权利上睡觉的人“——从“沉睡的权利”到正当救济的司法考量.pdf",
    "“沉睡的权利”与正当救济：诉讼时效制度的司法实践.docx",
  ],
  第五期: [
    "教学材料指南",
    "裁判文书法理导学",
...
function buildCourseArchivePeriods(videoPeriods) {
  return videoPeriods.map((item) => ({
    ...
    description:
      item.playerMode === "segments"
        ? "本期保留分段课堂内容与前期课程实施线索，课程档案页集中承接主题说明、配套材料与本期观看入口。"
        : "本期以课程档案方式集中承接主题说明、配套材料与对应视频入口，形成完整的单元化课程归档。",
  ...
  return {
    ...
    homeOverview: [
      ...
      },
      {
        href: "/resources",
        title: "课程视频",
        description: "八期课程视频成果与阶段说明在站内连续展示。",
      },
    ],
    homeImpactClosing: {
      href: "/impact",
    ...
    videoHub: {
      title: "八期课程视频成果",
      hero: "八期视频成果按照统一主线连续呈现，前四期侧重课堂实施与机制验证，后四期集中展示示范性课程视频与资源化成果。",
      phaseGuide,
      periods: videoPeriods,
      segmentNotice: {
        title: "第一期、第二期分段内容在本期说明页内展开",
        description: "课程视频总览页只保留八期主卡片，进入第一期或第二期后再查看对应分段入口。",
      },
    },
    platformHighlights: [
      {
