...
export function buildShowcaseContent() {
  ...
  return {
    site: {
      ...
      intro: "围绕裁判文书研习、双师课程、教学资源与实践成效，系统呈现法理学教学改革的课程建设、平台支撑与育人成果。",
    },
    nav: [
    ...
    homeFlow: [
      ...
      },
      {
        id: "02",
        title: "再在案例详情页中阅读导读",
        description: "结合摘要、法院、案号、裁判结果与文书入口，判断是否继续精读。",
      },
      {
        id: "03",
        title: "最后进入研习工作台完成分析",
    ...
    platformHighlights: [
      {
        eyebrow: "平台能力",
        title: "案例、阅读与研习一体贯通",
        description: "从案例检索到案例阅读，再到研习工作台，平台围绕同一份裁判文书组织完整的学习链路。",
      },
      {
        eyebrow: "课程支撑",
        title: "让课程、资源与平台形成统一入口",
        description: "案例资源、八期课程与标准化材料被组织到同一入口中，便于整体浏览与分项查阅。",
      },
      {
        eyebrow: "成果呈现",
        title: "课程建设与平台运行相互印证",
        description: "课程体系、教学资源与建设成效在站内形成前后呼应的浏览结构，便于连续阅读和成果呈现。",
      },
    ],
    metrics: {
      caseCount: {
