...
const DEFAULT_ARCHIVE_MATERIALS = [
  "教学材料指南",
  "裁判文书法理导学",
  "裁判文书研习任务单",
];
...
function buildCourseArchivePeriods(videoPeriods) {
  return videoPeriods.map((item) => ({
    ...
    materials: COURSE_MATERIALS_BY_PERIOD[item.period] ?? DEFAULT_ARCHIVE_MATERIALS,
  ...
  return {
    ...
    homeResultTracks: [
      ...
      },
      {
        title: "课程建设",
        value: "8期课程",
        detail: "八期课程均可进入课程页，阅读主题、问题与材料摘要。",
        href: "/courses",
        actionLabel: "查看课程导览",
      },
      {
    ...
    homeOverview: [
      {
        href: "/courses",
        title: "课程体系",
        description: "逐期阅读课程主题、视频与配套资料，了解每一期开展的核心内容。",
      },
      {
        href: "/resources",
        title: "课程视频",
