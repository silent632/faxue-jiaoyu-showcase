...
const COURSE_VIDEO_PERIODS = [
  buildShowcaseVideoPeriod({
    ...
    purpose: "本期可直接在站内观看，并结合课程档案页继续查看类案检索起点、导读示范与课堂讨论的配套材料。",
    sourceHref: PERIOD_01_VOD_MP4,
  }),
  buildShowcaseVideoPeriod({
    ...
    purpose: "本期可直接在站内观看，并结合课程档案页继续查看原理辨析、案例回应与课堂延展的配套材料。",
    sourceHref: PERIOD_02_VOD_MP4,
  }),
  buildShowcaseVideoPeriod({
  ...
  buildShowcaseVideoPeriod({
    ...
    summary: "围绕非法证据排除规则，讨论程序正义如何限制国家取证权力，并明确证据能力审查的关键标准。",
    purpose: "通过典型取证争议，训练对排除条件、举证责任和裁判说理的判断。",
  ...
  buildShowcaseVideoPeriod({
    ...
    summary: "围绕人脸识别场景，拆解明示同意、默示同意与拒绝权的同意边界，聚焦人格权保护的判断标准。",
    purpose: "通过商场、社区等具体应用场景，判断同意是否有效以及处理行为是否构成人格权侵害。",
  ...
  buildShowcaseVideoPeriod({
    ...
    summary: "围绕生成式 AI 文图内容，讨论作品认定标准与平台、使用者、模型提供方之间的责任边界。",
    purpose: "通过侵权争议案例训练作品属性判断、责任分配论证和裁判路径拆解。",
