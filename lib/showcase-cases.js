...
const DEFAULT_SOURCE_JSON_CANDIDATES = [
  path.join(REPO_ROOT, "data/generated/cases-extracted.json"),
  path.join(REPO_ROOT, "public/generated/cases-extracted.json"),
  path.resolve(REPO_ROOT, "../faxue-jiaoyu/data/generated/cases-extracted.json"),
  path.resolve(REPO_ROOT, "../faxue-jiaoyu-education/data/generated/cases-extracted.json"),
  "/Users/silent/Projects/faxue-jiaoyu/data/generated/cases-extracted.json",
  "/Users/silent/Projects/faxue-jiaoyu-education/data/generated/cases-extracted.json",
];
...
export function resolveShowcaseCasesJsonPath({ env = process.env, cwd = REPO_ROOT } = {}) {
  const dynamicCandidates = [
    env.SHOWCASE_CASES_JSON_PATH,
    env.SHOWCASE_SOURCE_ROOT ? path.join(env.SHOWCASE_SOURCE_ROOT, "data/generated/cases-extracted.json") : "",
    path.join(cwd, "data/generated/cases-extracted.json"),
    path.join(cwd, "public/generated/cases-extracted.json"),
  ];

  const candidates = [...dynamicCandidates, ...DEFAULT_SOURCE_JSON_CANDIDATES]
  ...
  return uniqueCandidates.find((item) => fs.existsSync(item)) || uniqueCandidates[0] || path.join(cwd, "data/generated/cases-extracted.json");
}

export async function readShowcaseCaseSourceRows({
  jsonPath = resolveShowcaseCasesJsonPath(),
} = {}) {
  try {
