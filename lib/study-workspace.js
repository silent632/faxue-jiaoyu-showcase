...
export function getPublicStudyActionState() {
  return {
    canSubmit: false,
    canAutosave: true,
    submitMessage: "可继续记录研习内容，线上提交入口暂未开放。",
    autosaveMessage: "填写内容会保存在当前浏览器中，便于稍后继续整理。",
  };
}
...
export async function submitStudyWorkspace() {
  return {
    ...
    tone: "warning",
    title: "暂不支持线上提交",
    message: "当前页面支持继续整理研习内容，并将填写结果保存在当前浏览器中；如需提交，可在线下汇总后统一使用。",
  };
}
