...
const DEFAULT_SOURCE_ROOT = path.resolve(PROJECT_ROOT, "..", "faxue-jiaoyu");
...
export function resolvePdfSyncSourceDir({ sourceDir, sourceRoot } = {}) {
  ...
  const root = String(sourceRoot || process.env.SHOWCASE_SOURCE_ROOT || DEFAULT_SOURCE_ROOT).trim();
  return path.join(root, "public", "pdfs");
}
