...
const backLinkStyles = {
  ...
  padding: "0.8rem 1rem",
  borderRadius: "999px",
  background: "rgba(139, 91, 43, 0.12)",
  border: "1px solid rgba(139, 91, 43, 0.16)",
  color: "var(--accent)",
  fontWeight: 700,
};
    ...
    <main className="showcase-page">
      ...
      <div className="showcase-page-body">
        ...
        <div style={metaGridStyles}>
          <article className="showcase-card" style={metaCardStyles}>
        ...
        <div className="stack-grid">
          <ShowcaseSection title="案例摘要" description="保留原始源数据中的教学导读摘要，便于公开浏览与后续研习。">
            <p className="case-detail-copy" style={copyStyles}>{caseItem.summary || "暂无摘要信息。"}</p>
          </ShowcaseSection>

          <ShowcaseSection title="事实要点" description="聚焦课堂研习中的事实梳理与情境理解。">
            <p className="case-detail-copy" style={copyStyles}>{caseItem.refFact || "暂无事实要点。"}</p>
          </ShowcaseSection>

          <ShowcaseSection title="争议焦点" description="用于组织课堂提问与小组讨论。">
            <p className="case-detail-copy" style={copyStyles}>{caseItem.refIssue || "暂无争议焦点。"}</p>
          </ShowcaseSection>

          <ShowcaseSection title="法理要点" description="帮助学生将事实、规范与结论连接起来。">
            <p className="case-detail-copy" style={copyStyles}>{caseItem.refLegal || "暂无法理要点。"}</p>
          </ShowcaseSection>

          <ShowcaseSection title="相关法条" description="展示系统整理的规范引用。">
            <div style={lawsGridStyles}>
          ...
          <div>
            <Link href="/cases" style={backLinkStyles}>
              返回案例检索库
            </Link>
          </div>
        </div>
