...
function defaultSectionMeta(item) {
  return {
    eyebrow: "项目成效",
    title: item.title,
...
function buildSectionMeta(item) {
  return sectionMetaByTitle[item.title] ?? defaultSectionMeta(item);
}

function defaultImpactSummary(item) {
...
function buildImpactSummary(item) {
      ...
      <div className="showcase-page-body">
        ...
        <div className="stack-grid">
          {content.impact.sections.map((item) => {
            const sectionMeta = buildSectionMeta(item);
